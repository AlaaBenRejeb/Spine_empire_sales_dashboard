...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <aside className={`fixed top-0 left-0 w-64 flex flex-col gap-6 h-screen p-6 border-r border-glass-border bg-black transition-all duration-300 overflow-hidden shadow-2xl z-50 ${isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>
